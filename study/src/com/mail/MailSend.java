...
public class MailSend {
	...
	public boolean sendMail() {
		...
		try {
			...
			prop.put("main.smtp.host", mailHost);
			...
			// 메일내용과 파일을 MimeBodyPart로 나누어 담음
			makeMessage(msg);
	...
	private void makeMessage(Message msg) throws MessagingException{
		...
		if(fileFullPath==null || fileFullPath.equals("")) {
			...
			try {
				...
				System.out.println(e.toString()+"makeMessage");
			}
			...
			msg.setContent(mp); 	// 메일내용과 파일이 content에 들어감.
		}
